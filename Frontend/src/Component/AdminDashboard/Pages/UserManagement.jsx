...
const UserManagement = () => {
    ...
    axios.get('http://localhost:9091/account/getAllAccount', {
      ...
      .then(response => {
        ...
        const filteredData = response.data.filter(user => {
          const roleName = user.userAccount.roles?.[0]?.roleName;
          return roleName === 'ROLE_MANAGER' || roleName === 'ROLE_EMPLOYEE' || roleName === 'ROLE_CONTENTWRITER';
        });
  ...
  // Delete user based on role name
    ...
    if (userToDelete) {
      ...
      switch (roleName) {
        ...
        case 'ROLE_EMPLOYEE':
          ...
          break;
        case 'ROLE_CONTENTWRITER':
          deleteUrl = `http://localhost:9091/user/deleteContentWriter/${userId}`;
          break;
        default:
          break;
      }
    ...
    const handleFormSubmit = (e) => {
      ...
      switch (roleName) {
        ...
        case 'ROLE_EMPLOYEE':
          ...
          break;
        case 'ROLE_CONTENTWRITER':
          updateUrl = `http://localhost:9091/account/updateContentWriterAccount/${accountId}`;
          break;
        default:
          break;
      }
      ...
      if (updateUrl !== '') {
        axios
          ...
          .then((response) => {
            ...
            // Assuming response.data contains the updated data from the server
            // const updatedUsers = { ...usersData };
            // updatedUsers.userAccount = response.data.userAccount;
            // setUsersData(updatedUsers);
      ...
      <div className="update-form-container">
        ...
        <form >
          ...
          <div className="form-buttons">
            <button type="submit" onClick={handleFormSubmit} style={{background:'#861f41',color:'white'}}>Update</button>
          ...
          >
            ...
            >
              ...
              >
                ...
                <button onClick={cancelUpdateUser}>No</button>
              </div>
            </div>
          </div>
        )}
