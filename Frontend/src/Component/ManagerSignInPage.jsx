      ...
      .then((res) => {
        ...
        axios
          ...
          .then((response) => {
            ...
            if (response.data === 'ROLE_MANAGER') {
              // Login successful for ROLE_ADMIN
              auth.login(userName, password, jwt);
              nav(redirectPath, { replace: true });
            } else {
              // User does not have ROLE_ADMIN, show error dialog
...
export default ManagerSignPage;