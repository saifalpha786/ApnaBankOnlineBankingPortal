...
const ContentWriterSignInPage = () => {
  const [loginSuccess, setLoginSuccess] = useState(false);
  const [userName, setUserName] = useState('');
  const [password, setPassword] = useState('');
  const [showPassword, setShowPassword] = useState(false);
  const [showWrongCredentialsDialog, setShowWrongCredentialsDialog] =
    useState(false);
      ...
      .then((res) => {
        ...
        axios
          ...
          .then((response) => {
            ...
            if (response.data === 'ROLE_CONTENTWRITER') {
              // Login successful for ROLE_CONTENTWRITER
              auth.login(userName, password, jwt);
              nav(redirectPath, { replace: true });
            } else {
              // User does not have ROLE_CONTENTWRITER, show error dialog
...
export default ContentWriterSignInPage;